...
document.getElementById("direction").innerHTML=dataa.query.result.channel.wind.direction;
document.getElementById("speed").innerHTML=dataa.query.result.channel.wind.speed;
